...
/** Module for building http4s Ember Client If you want to customize your configuration instead of the default client,
  * you must inherit this module to build it.
  *
  * example:
  * {{{
  *   @Singleton
