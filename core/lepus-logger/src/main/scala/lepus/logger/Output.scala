...
/** [[org.legogroup.woof.Output]] extension object. A method has been added to Output to export StackTrace. copied from
  * woof: https://github.com/LEGO/woof/blob/main/modules/core/shared/src/main/scala/org/legogroup/woof/Output.scala
  *
  * @tparam F
  *   the effect type.
  */
