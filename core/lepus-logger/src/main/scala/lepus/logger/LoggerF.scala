...
trait LoggerF[F[_]]:
  ...
  inline def trace[M](msg: => M, ex: Throwable, ctx: Map[String, String]): Execute[F, Unit] =
  ...
  inline def debug[M](msg: => M, ex: Throwable, ctx: Map[String, String]): Execute[F, Unit] =
  ...
  inline def info[M](msg: => M, ex: Throwable, ctx: Map[String, String]): Execute[F, Unit] =
  ...
  inline def warn[M](msg: => M, ex: Throwable, ctx: Map[String, String]): Execute[F, Unit] =
  ...
  inline def error[M](msg: => M, ex: Throwable, ctx: Map[String, String]): Execute[F, Unit] =
